...
\end{aligned}
\end{aligned} \\
&(x_n)\text{ ist monoton fallend} \\ %KORRIGIERE AB HIER
...
% ENDE STETIGKEIT
\newpage
\section{Differential- und Integralrechnung} % sollte 5. sein????
...
%$\displaystyle  (\cos x)' = \left( \frac{\e^{\im x} + \e^{-\im x}}{2}\right)' = \frac{\e^{\im x}' + \e^{-\im x}'}{2} = \frac{\im \e^{\im x} - \im \e^{-\im x}}{2} = \im  \frac{\e^{\im x} - \e^{-\im x}}{2} \overset{\frac{-1}{\im}{=} - \frac{\e^{\im x} - \e^{-\im x}}{2\im} = \sin x $

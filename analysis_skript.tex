...
\newtheorem{satzaux}{Satz}[section]
\newtheorem{korraux}[satzaux]{Korollar}
\newtheorem{propaux}[satzaux]{Proposition}
\newtheorem{defiaux}[satzaux]{Definition}
\newtheorem{bspaux}[satzaux]{Beispiel}
\newtheorem{bemaux}[satzaux]{Bemerkung}
\newtheorem{subsatzaux}{Satz}[subsection]
\newtheorem{subkorraux}[subsatzaux]{Korollar}
\newtheorem{subpropaux}[subsatzaux]{Proposition}
\newtheorem{subdefiaux}[subsatzaux]{Definition}
\newtheorem{subbspaux}[subsatzaux]{Beispiel}
\newtheorem{subbemaux}[subsatzaux]{Bemerkung}

\NewDocumentEnvironment{satz}{o}
 {\IfNoValueTF{#1}
   {\satzaux\addcontentsline{toc}{subsection}{\protect\numberline{\thesubsection}Satz}}
 ...
 {\IfNoValueTF{#1}
   ...
   {\bemaux[#1]\addcontentsline{toc}{subsection}{\protect\numberline{\thesubsection}Bemerkung (#1)}}%
   \ignorespaces}
 {\endbemaux}

\NewDocumentEnvironment{subsatz}{o}
 {\IfNoValueTF{#1}
   {\subsatzaux\addcontentsline{toc}{subsubsection}{\protect\numberline{\thesubsubsection}Satz}}
 ...
 {\IfNoValueTF{#1}
   ...
   {\subbemaux[#1]\addcontentsline{toc}{subsubsection}{\protect\numberline{\thesubsubsection}Bemerkung (#1)}}%
   \ignorespaces}
 {\endsubbemaux}
...
\newpage
\begin{subsatz}[Rechenregeln für konvergente Folgen]
...
\begin{subsatz}[Sandwich-Theorem]
...
\begin{subsatz}[von Bolzano-Weierstraß]
...
\begin{subbsp}[Verfahren zur Berechnung der Quadratwurzel]
